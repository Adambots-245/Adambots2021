...
public class MyRamsete extends CommandBase {
  ...
  public void execute() {
    ...
    System.out.println("Ramsete velocity: " + m_trajectory.sample(curTime).velocityMetersPerSecond);
    System.out.println("Ramsete acceleration: " + m_trajectory.sample(curTime).accelerationMetersPerSecondSq);
    System.out.println("Ramsete left setpoint: " + leftSpeedSetpoint);
    System.out.println("Ramsete right setpoint: " + rightSpeedSetpoint);
    System.out.println("Ramsete left m/s: " + m_prevSpeeds.leftMetersPerSecond);
    System.out.println("Ramsete right m/s: " + m_prevSpeeds.rightMetersPerSecond);
    ...
    System.out.println("Ramsete Is turning right: " + (leftOutput > rightOutput));
