...
public final class Constants {
	...
	public static final int TALON_TOP_BUFFER_MAX_COUNT = 512; // Maximum number of trajectories to be stored in the top buffer (API)
	public static final int TALON_BTM_BUFFER_MAX_COUNT = 128; // Maximum number of trajectories to be stored in the bottom buffer (Talon RAM)
